{ lib, ... }:
{
  ...
  boot.kernel.sysctl = {
    ...
    "vm.swappiness" = lib.mkDefault 140; # 180
    ...
    # "vm.vfs_cache_pressure","vm.page_lock_unfairness" for laptop
    # vfs cache pressure: Reduce the recovery pressure on the dentry/inode cache (desktop programs benefit greatly) 
    "vm.vfs_cache_pressure" = lib.mkDefault 50;

    # page lock unfairness: Reduce lock contention, suitable for multi-core laptop
    "vm.page_lock_unfairness" = lib.mkDefault 1;
  };
}